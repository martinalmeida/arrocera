...
class crud
{
    ...
    private $conn;
    private $table_name = "trilladores";
    ...
    {
        $query = "SELECT * FROM " . $this->table_name . " WHERE id_trillador  =  " . $this->data . " ";
    ...
    function makeUpdate()
    {
        $query = "UPDATE " . $this->table_name . " SET nombre=?, cedula=?, telefono=?, whatsapp=?  WHERE id_trillador = " . $this->id . " ";
        $stmt = $this->conn->prepare($query);
        $this->nombre = htmlspecialchars(strip_tags($this->nombre));
        $this->cedula = htmlspecialchars(strip_tags($this->cedula));
        $this->telefono = htmlspecialchars(strip_tags($this->telefono));
    ...
    function delete()
    {
        $query = "DELETE FROM " . $this->table_name . " WHERE id_trillador =  " . $this->data . " ";
        $stmt = $this->conn->prepare($query);
        $stmt->execute();
