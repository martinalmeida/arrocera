...
class crud
{
    ...
    {
        $query = "SELECT * FROM " . $this->table_name . " WHERE id_fiscal  =  " . $this->data . " ";
    ...
    function makeUpdate()
    {
        $query = "UPDATE " . $this->table_name . " SET nombre=?, cedula=?, telefono=?, correo=?, whatsapp=?  WHERE id_fiscal = " . $this->id . " ";
        $stmt = $this->conn->prepare($query);
        $this->nombre = htmlspecialchars(strip_tags($this->nombre));
        $this->cedula = htmlspecialchars(strip_tags($this->cedula));
        $this->telefono = htmlspecialchars(strip_tags($this->telefono));
    ...
    function delete()
    {
        $query = "DELETE FROM " . $this->table_name . " WHERE id_fiscal =  " . $this->data . " ";
        $stmt = $this->conn->prepare($query);
        $stmt->execute();
