...
class crud
{
    ...
    {
        $query = "SELECT * FROM " . $this->table_name . " WHERE id_tesorero  =  " . $this->data . " ";
    ...
    function create()
    {
        $query = "INSERT INTO " . $this->table_name . " SET nombre=?, cedula=?, telefono=?, correo=?, whatsapp=? ";
        $stmt = $this->conn->prepare($query);
    ...
    function makeUpdate()
    {
        $query = "UPDATE " . $this->table_name . " SET nombre=?, cedula=?, telefono=?, correo=?, whatsapp=?  WHERE id_tesorero = " . $this->id . " ";
        $stmt = $this->conn->prepare($query);
        $this->nombre = htmlspecialchars(strip_tags($this->nombre));
        $this->cedula = htmlspecialchars(strip_tags($this->cedula));
        $this->telefono = htmlspecialchars(strip_tags($this->telefono));
    ...
    function delete()
    {
        $query = "DELETE FROM " . $this->table_name . " WHERE id_tesorero =  " . $this->data . " ";
        $stmt = $this->conn->prepare($query);
        $stmt->execute();
