...
<body>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						...
						<ul id="auth" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="../referente/referente.php">Referente Subnucleo</a></li>
		...
		<div class="main">
			...
			<main class="content">
				...
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3"><strong>Tabla</strong> Referente Subnucleo</h1>
							...
							<div class="table-responsive" style="width:100%">
								<table class="table table-bordered table-striped table-hover">
									<thead>
										<tr>
											<th scope="col">#</th>
											<th scope="col">Nombre Referente Subnucleo</th>
	...
	<script src="../../assets/js/fetch/referente.js"></script>
