    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel">Insertar Representante</h5>
            ...
            <div class="modal-body">
                <form id="formulario_insert" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Ingresa nombre" id="nombre_repre" name="nombre_repre" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" placeholder="Ingresa un correo" id="correo" name="correo" required>
                    </div>
                    <div class="mb-3">
