    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title text-white" id="exampleModalLabel">Editar Representante</h5>
            ...
            <div class="modal-body">
                <form id="formulario_update" method="POST">
                    <div class="mb-3">
                        ...
                        <label for="exampleInputEmail1" class="form-label"><strong>Nombre de Representante:</strong></label>
                        <input type="text" class="form-control" placeholder="Ingresa nombre" id="nombre_repre_up" name="nombre_repre_up" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" placeholder="Ingresa un correo" id="correo_up" name="correo_up" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label"><strong>Whatsapp:</strong></label>
                        <input type="text" class="form-control" id="whatsapp_up" name="whatsapp_up" required>
                    </div>
            </div>
