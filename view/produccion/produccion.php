...
<body>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						...
						<ul id="produc" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="../produccion/produccion.php">Produccion</a></li>
						</ul>
					</li>
					<li class="sidebar-item">
		...
		<div class="main">
			...
			<main class="content">
				...
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3"><strong>Tabla</strong> Produccion</h1>
								...
								<table class="table table-bordered table-striped table-hover">
									<thead>
										<tr>
											...
											<th scope="col">Area Sembrado</th>
											<th scope="col">Fecha</th>
											<th scope="col">Variedad de Arroz</th>
	...
	<script src="../../assets/js/fetch/produccion.js"></script>
