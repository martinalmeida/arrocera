    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title text-white" id="exampleModalLabel">Editar Responsable</h5>
            ...
            <div class="modal-body">
                <form id="formulario_update" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Ingresa el nombre" id="nombre_up" name="nombre_up" required>
                    </div>
                    <div class="mb-3">
