...
<body>
			...
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						...
						<ul id="produc" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
							<li class="sidebar-item active"><a class="sidebar-link" href="../variedad/variedad.php">Variedad de Arroz</a></li>
		...
		<div class="main">
			...
			<main class="content">
				...
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3"><strong>Tabla</strong> Variedad de Arroz</h1>
							...
							<div class="table-responsive" style="width:100%">
								<table class="table table-bordered table-striped table-hover">
									<thead>
										<tr>
											<th scope="col">#</th>
											<th scope="col">Nombre Variedad</th>
											<th scope="col">Periodo de Vegetacion</th>
	...
	<script src="../../assets/js/fetch/variedad.js"></script>
