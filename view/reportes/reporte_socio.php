			...
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						...
						<ul id="report" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
							<li class="sidebar-item active"><a class="sidebar-link" href="../reportes/reporte_socio.php">Reporte Socio</a></li>
						</ul>
					</li>
		...
		<div class="main">
			...
			<main class="content">
				...
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3"><strong>Reporte</strong> Socios</h1>
					<div class="card">
						<div class="card-body">
							<form class="row g-3" action="reporte.php" method="POST">
								<div class="col-md-12">
									<label for="exampleInputPassword1" class="form-label"><strong>Nombre de Socio:</strong></label>
									<select class="form-select" aria-label="Default select example" name="socio" required>
