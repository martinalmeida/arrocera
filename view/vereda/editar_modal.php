    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title text-white" id="exampleModalLabel">Editar Vereda</h5>
            ...
            <div class="modal-body">
                <form id="formulario_update" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre_vereda_up" name="nombre_vereda_up" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label"><strong> Descripción:</strong></label>
                        <input type="text" class="form-control" id="descripcion_up" name="descripcion_up" required>
                    </div>
            </div>
