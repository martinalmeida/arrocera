...
include_once '../../model/objects/nucleo.php';
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="exampleModalLabel">Insertar Nucleo</h5>
            ...
            <div class="modal-body">
                <form id="formulario_insert" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Ingresa el nombre de la asociacion" id="nombre" name="nombre" required>
                    </div>

                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label"><strong>Responsable:</strong></label>
                        <select class="form-select" aria-label="Default select example" id="fk_responsable" name="fk_responsable" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" id="fk_trillador" name="fk_trillador" required>
