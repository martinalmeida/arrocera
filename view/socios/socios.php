...
<body>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						...
						<ul id="auth" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="../socios/socios.php">Socios</a></li>
						</ul>
					</li>
					<li class="sidebar-item">
		...
		<div class="main">
			...
			<main class="content">
				...
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3"><strong>Tabla</strong> Socios</h1>
	...
	<script src="../../assets/js/fetch/socios.js"></script>
