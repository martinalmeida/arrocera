...
async function cargarTablaAsync(){
    let info;
    const data = await fetch("../../model/representante/table.php");
    const resulatdo = await data.json();
    info = resulatdo.map(e => {
        return `<tr>
                    <td>${e.id_representante}</td>
                    ...
                    <td class="text-center">
                        <button type="button" class="btnEditar btn btn-success" data-bs-toggle="modal" data-bs-target="#update_modal" onclick="updateForm('${e.id_representante}');">Editar <i class="far fa-edit text-white"></i></button> 
                        <button class="btn btn-danger" onclick="eliminaregistro('${e.id_representante}');" >Eliminar <i class="far fa-minus-square text-white"></i></button>
                    </td>
                </tr>`;        
    }).join('');
...
window.addEventListener('load', () => {
    ...
    let nombre_repre = document.getElementById('nombre_repre');
    ...
    function data() {
        ...
        datos.append("nombre_repre", nombre_repre.value);
        ...
        fetch('../../model/representante/insert.php', {
            method: 'POST',
            body: datos
...
function eliminaregistro(id) {
    ...
    fetch("../../model/representante/delete.php", {
        method: "POST",
        body: id
...
let nombre_repre_up = document.getElementById('nombre_repre_up');
...
function updateForm(id) {
    fetch("../../model/representante/select_update.php", {
        method: "POST",
        body: id
    }).then(response => response.json()).then(response => {
        id_form.value = response.id_representante;
        nombre_repre_up.value = response.nombre_repre;
...
window.addEventListener('load', () => {
    ...
    function data() {
        ...
        datos.append("nombre_repre_up", nombre_repre_up.value);
        ...
        fetch('../../model/representante/update.php', {
            method: 'POST',
            body: datos
        }).then(Response => Response.json())
        .then(({ success }) => {
