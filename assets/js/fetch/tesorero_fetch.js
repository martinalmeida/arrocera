...
async function cargarTablaAsync(){
    let info;
    const data = await fetch("../../model/tesorero/table.php");
    ...
    info = resulatdo.map(e => {
        return `<tr>
                    ...
                    <td class="text-center">
                        <button type="button" class="btnEditar btn btn-success" data-bs-toggle="modal" data-bs-target="#update_modal" onclick="updateForm('${e.id_tesorero}');">Editar <i class="far fa-edit text-white"></i></button> 
                        <button class="btn btn-danger" onclick="eliminaregistro('${e.id_tesorero}');" >Eliminar <i class="far fa-minus-square text-white"></i></button>
                    </td>
                </tr>`;        
    }).join('');
...
window.addEventListener('load', () => {
    ...
    function data() {
        ...
        fetch('../../model/tesorero/insert.php', {
            method: 'POST',
            body: datos
...
function eliminaregistro(id) {
    ...
    fetch("../../model/tesorero/delete.php", {
        method: "POST",
        body: id
...
function updateForm(id) {
    fetch("../../model/tesorero/select_update.php", {
        method: "POST",
        body: id
    }).then(response => response.json()).then(response => {
        id_form.value = response.id_tesorero;
...
window.addEventListener('load', () => {
    ...
    function data() {
        ...
        fetch('../../model/tesorero/update.php', {
            method: 'POST',
            body: datos
        }).then(Response => Response.json())
        .then(({ success }) => {
