...
async function cargarTablaAsync(){
    let info;
    const data = await fetch("../../model/fiscal/table.php");
    ...
    info = resulatdo.map(e => {
        return `<tr>
                    ...
                    <td class="text-center">
                        <button type="button" class="btnEditar btn btn-success" data-bs-toggle="modal" data-bs-target="#update_modal" onclick="updateForm('${e.id_fiscal}');">Editar <i class="far fa-edit text-white"></i></button> 
                        <button class="btn btn-danger" onclick="eliminaregistro('${e.id_fiscal}');" >Eliminar <i class="far fa-minus-square text-white"></i></button>
                    </td>
                </tr>`;        
    }).join('');
...
function updateForm(id) {
    fetch("../../model/fiscal/select_update.php", {
        method: "POST",
        body: id
    }).then(response => response.json()).then(response => {
        id_form.value = response.id_fiscal;
